...
function Header ( {
    ...
    function createLis () {
        ...
        const lis = chapters[ language ].map( item => (
            ...
            lis.push( <li key="icon" className={ "icons" }><Icon/></li> );
...
function LanguageIcon () {
    ...
    return (
        ...
        >
            ...
            <aside
                className={ is_focus ? "visible": "hidden" }
    ...
    // BUG: 似乎是因为focus被连续触发两次，所以才会导致一直都不显示aside。
    function handleButtonClick () {

        const next_is_focus = ! is_focus;

        reference.current[ next_is_focus ? "focus" : "blur" ]();
